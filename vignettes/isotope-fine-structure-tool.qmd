...
shows what is really inside it. For M+2, a 37Cl isotopologue dominates so
completely that the small 13C,13C shoulder is almost invisible on a linear scale:
...
visually obvious as a separate hump, consistent with the table above. This is the
...
2. **Zoom into the nominal level** that shows the excess to see which specific
   isotopologues could produce it, and how far apart they sit in exact mass
   (in Da, directly comparable to your spectrum's own axis).
