...
`isotope_fine_pattern()` wraps [enviPat](https://cran.r-project.org/package=enviPat)
to enumerate every isotopologue of a formula above a threshold, labelled by which
